...
import com.stc.filesystem.mapper.ItemMapper;
import com.stc.filesystem.service.ItemServiceImple;
...
public class ItemController {
	...
	@Autowired
	ItemServiceImple service;
	//here i will make the return another object using Mapstruct Mapping 
	@PostMapping
